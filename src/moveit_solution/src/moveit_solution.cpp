...
SrvClass::SrvClass(ros::NodeHandle& nh)
{
  ...
  // define a namespace for our ROS services, they will appear as "/namespace/srv_name"
  ...
  ROS_INFO("MoveIt! services initialisation finished, namespace: %s", service_ns.c_str());
}

/* ----- Service callbacks ----- */

bool SrvClass::setArmCallback(moveit_solution::set_arm::Request &request,
...
bool SrvClass::setGripperCallback(moveit_solution::set_gripper::Request &request,
...
bool SrvClass::addCollisionCallback(moveit_solution::add_collision::Request &request,
...
bool SrvClass::removeCollisionCallback(moveit_solution::remove_collision::Request &request,
...
bool SrvClass::pickCallback(moveit_solution::pick::Request &request,
...
bool SrvClass::moveArm(geometry_msgs::Pose target_pose)
{
...
bool SrvClass::moveGripper(float width)
{
...
void SrvClass::addCollisionObject(std::string object_name,
...
void SrvClass::removeCollisionObject(std::string object_name)
{
...
bool SrvClass::pick(geometry_msgs::Point position)
{
  ...
  // adjust orientation to make 0deg parallel to origin axes
  double orientation = pi / 4;

  // determine the grasping orientation
  tf2::Quaternion q_object;
  q_object.setRPY(0, 0, orientation);
